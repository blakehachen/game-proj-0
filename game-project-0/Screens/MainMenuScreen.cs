...
namespace game_project_0.Screens
{
    public class MainMenuScreen : MenuScreen
    {
        ...
        {
            var playGameMenuEntry = new MenuButton("Play", new Vector2(0, 0), "Not Implemented", -30, -16, -15, 0);
            var settingsGameMenuEntry = new MenuButton("Settings", new Vector2(0,0), "Not Implemented", -60, -16, -15, 0);
            var quitGameMenuEntry = new MenuButton("Quit", new Vector2(0, 0), "Press [ENTER] or A to Quit", -30, -16, -75, 0);
